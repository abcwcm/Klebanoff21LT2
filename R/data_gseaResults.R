#### RESULTS OF GSEA ANALYSES ############
##########################################

#' fGSEA results of the most reactive clonotype comparing Mut vs WT for PID gene sets
#'
#' @description Results of gene set enrichment analyses using the logFC values
...
#'
#' @details See the vignette about DEG analyses for details.
#'
#' @docType data
#' @keywords datasets
#' @name gns_dropouts
#' @usage data(fgsea_pid_degns.c20)
#' @format data.frame with GSEA results, generated by \code{\link{fsgea::fgsea}}.
...
#' fGSEA results of c20 Mut vs WT for REACTOME gene sets
#'
#' @description Results of gene set enrichment analyses using the logFC values
...
#'
#' @details See  the vignette about DEG detection for details.
#'
#' @docType data
#' @keywords datasets
#' @name gns_dropouts
#' @usage data(fgsea_reactome_degns.c20)
#' @format data.frame with GSEA results, generated by \code{\link{fsgea::fgsea}}.
#'  Each row corresponds to a tested pathway. The columns are the following:
#'
#'  \itemize{
...
#' fGSEA results of c20 Mut vs WT for KEGG gene sets
#'
#' @description Results of gene set enrichment analyses using the logFC values
#' for all genes when comparing MUT vs WT exposed cells for clonotype c20.
#' The gene sets that were tested were the KEGG gene sets from MSigDB (v.7).
#'
#' @details See the vignette about DE gene detection for details.
#'
#' @docType data
#' @keywords datasets
#' @name gns_dropouts
#' @usage data(fgsea_kegg_degns.c20)
#' @format data.frame with GSEA results, generated by \code{\link{fsgea::fgsea}}.
#'  Each row corresponds to a tested pathway. The columns are the following:
#'
#'  \itemize{
